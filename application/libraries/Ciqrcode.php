...
class Ciqrcode
{
	...
	public function generate($params = array()) {
		...
		if (isset($params['savename'])) {
			...
			QRcode::png($params['data'], $params['savename'], $level, $size*1.35, 0);//0 untuk tidak menggunakan border
			...
			QRcode::png($params['data'], NULL, $level, $size*1.35, 0);//0 untuk tidak menggunakan border
		}
	}
}
